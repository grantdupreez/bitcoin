...
select_short = st.sidebar.slider('Set SMA', min_value=1, max_value=20, value=10, step=1)
select_long = st.sidebar.slider('Set SMA', min_value=1, max_value=100, value=40, step=10)
