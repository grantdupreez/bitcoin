...
select_period = st.sidebar.selectbox('Select period?', ('1d','5d','10d','1mo', '3mo', '6mo', '1y', '2y', '5y', '10y', 'ytd','max'))
select_interval = st.sidebar.selectbox('Select interval?', ('1m','2m','5m','15m','30m','60m','90m','1d','5d','1wk','1mo','3mo'))
