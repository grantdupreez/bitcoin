...
select_short = st.sidebar.slider('Set short MA', min_value=1, max_value=20, value=10, step=1)
select_long = st.sidebar.slider('Set long MA', min_value=1, max_value=100, value=40, step=1)
select_vol_short = st.sidebar.slider('Set volume short window', min_value=1, max_value=20, value=10, step=1)
select_vol_long = st.sidebar.slider('Set volume long window', min_value=1, max_value=100, value=40, step=1)
